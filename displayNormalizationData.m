...
'FontSize',fontSizeMedium,'Callback',{@processData_Callback});
    ...
    %         erpPeriod = [0.05 0.2]; 
            ...
            uicontrol('Parent',hPlotOptionsPanel,'Unit','Normalized',...
                'Position',[0 3*plotOptionsHeight 0.5 plotOptionsHeight],...
                'Style','pushbutton','String','clear Plot',...
                'FontSize',fontSizeMedium,'Callback',{@cla_Callback});
            
            uicontrol('Parent',hPlotOptionsPanel,'Unit','Normalized',...
                'Position',[0.5 3*plotOptionsHeight 0.5 plotOptionsHeight],...
                'Style','pushbutton','String','Select New Session',...
                'BackgroundColor','w','ForegroundColor','r','FontSize',fontSizeMedium,'Callback',{@ChooseNewSession_Callback});
    ...
    %             hPlots_Fig3.hPlot2 = hOtherPanels;            
                ...
                if analysisMeasure == 1 % computing ERP
                    plotData(hPlots_Fig1,sessionNum,erpData.timeVals,erpData,oriTuningData,plotColor,analysisMethod,analysisMeasure,LFPdataProcessingMethod,relativeMeasuresFlag,NormalizeDataFlag,electrodeNum)
    ...
    %                 plotDataFig3(hPlots_Fig3,sessionNum,erpData.timeVals,erpData,ColorNeuralMeasures,analysisMethod,analysisMeasure,relativeMeasuresFlag,NormalizeDataFlag,electrodeNum)
                elseif analysisMeasure == 2 % computing Firing rate
                    plotData(hPlots_Fig1,sessionNum,firingRateData.timeVals,firingRateData,oriTuningData,plotColor,analysisMethod,analysisMeasure,LFPdataProcessingMethod,relativeMeasuresFlag,NormalizeDataFlag,electrodeNum)
    ...
    %                 plotDataFig3(hPlots_Fig3,sessionNum,firingRateData.timeVals,firingRateData,ColorNeuralMeasures,analysisMethod,analysisMeasure,relativeMeasuresFlag,NormalizeDataFlag,electrodeNum)
                ...
                elseif analysisMeasure == 4 || analysisMeasure == 5 || analysisMeasure == 6|| analysisMeasure == 7% computing alpha
                    if analysisMethod == 1
                        plotData(hPlots_Fig1,sessionNum,fftData.freqVals,fftData,oriTuningData,plotColor,analysisMethod,analysisMeasure,LFPdataProcessingMethod,relativeMeasuresFlag,NormalizeDataFlag,electrodeNum)
    ...
    %                     plotDataFig3(hPlots_Fig3,sessionNum,fftData.freqVals,fftData,ColorNeuralMeasures,analysisMethod,analysisMeasure,relativeMeasuresFlag,NormalizeDataFlag,electrodeNum)
                    elseif analysisMethod ==2 
                        plotData(hPlots_Fig1,sessionNum,energyData.freqVals,energyData,oriTuningData,plotColor,analysisMethod,analysisMeasure,LFPdataProcessingMethod,relativeMeasuresFlag,NormalizeDataFlag,electrodeNum)
...
%                 set(get(hParameterPanel,'Children'),'Enable','on');
%                 set(get(hPlotOptionsPanel,'Children'),'Enable','on');
%                 set(get(hAxesLimitsPanel,'Children'),'Enable','on');
...
function plotData(hPlots_Fig1,sessionNum,xs,data,oriTuningData,colorName,analysisMethod,analysisMeasure,LFPdataProcessingMethod,relativeMeasuresFlag,NormalizeDataFlag,electrodeNum)
...
if relativeMeasuresFlag
    ...
    elseif analysisMeasure == 4||analysisMeasure == 5||analysisMeasure == 6
        if analysisMethod == 2
            ...
            analysisData = (analysisData-analysisDataBL); % Change in fft amplitude expressed as log10 Units
        end
    end
end
