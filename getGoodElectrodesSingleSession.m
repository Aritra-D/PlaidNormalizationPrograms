...
[expDates,protocolNames,positionList] = dataInformationPlaidNorm(monkeyName,gridType,0); % Plaid Protocols
...
if getOriSelectiveFlag
   ...
   [prefOri, oriSelectivity] = getPrefOriAndOriSelectivitySpikes(monkeyName,tuning_expDate,tuning_protocolName,folderSourceString,gridType);
