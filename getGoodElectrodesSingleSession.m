...
function [allGoodElectrodesArray,allGoodElectrodesStr,goodElectrodes] = getGoodElectrodesSingleSession(monkeyName,gridType,SessionNum,dRange,getSpikeElectrodesFlag,unitID,spikeCutoff,snrCutoff,timeRangeFRComputation,contrastIndexList)
...
a=positionList(1); e=positionList(2);
    ...
    if getSpikeElectrodesFlag
        usefulElectrodes = intersect(usefulElectrodes,getRateAndSNRInfo(monkeyName,expDate,protocolName,unitID,spikeCutoff,snrCutoff,timeRangeFRComputation,contrastIndexList));
    end
...
% rates.
folderSave = 'E:\Projects\PlaidNormalizationProject\snrAndRatesPlaidNorm';
